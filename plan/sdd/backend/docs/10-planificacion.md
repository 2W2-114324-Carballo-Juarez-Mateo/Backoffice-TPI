...
- **T-B · Analítica Institucional** — *muestra en vez de gobernar* (PROFESOR consulta; ADMIN ve consolidado). Épicas EP-04..05 → `reporting-service`.
...
> **Must = US-01..08 y US-10 (43 SP)** · **Should = US-11..14** · **Could = US-09**. Detalle por historia (template + tareas con horas) en el repo `plan/sprint0/uh/` y `plan/tareas.md`.
