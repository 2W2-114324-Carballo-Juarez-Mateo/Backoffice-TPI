...
## 1. Objetivo
Exponer el catálogo global de parámetros de economía y operativos (**PAR-01..PAR-23**, base PRD PAR-01..18; PAR-24 asignado a T01; registro extensible) que el ADMIN configura y los Temas 03/05/08/10 **leen** para aplicar la economía, con versionado y cambios **solo hacia adelante** (RF-CFG-06).
