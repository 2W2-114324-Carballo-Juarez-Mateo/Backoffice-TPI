...
> **Capacidad:** 41.5 h - **Asignado:** 31 h - **Repo:** 2026-P4-BE/tpi-backoffice (mono-modulo, 1 datasource + 2 esquemas)
...
- **[BACK]** US-02 T2 - Adoptar el EventoDTO oficial + mapear ParameterChanged / GlobalConfigurationChanged (**reasignada de Julieta** - **HECHA**, rama `feature/us-02-envelope`) - 6h
