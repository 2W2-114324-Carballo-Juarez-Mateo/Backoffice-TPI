...
> **Capacidad:** 41.5 h - **Asignado:** 26 h - **Repo:** 2026-P4-BE/tpi-backoffice (mono-modulo, 1 datasource + 2 esquemas)
...
- **[FRONT]** FE-1 - Capa HTTP: provideHttpClient + interceptor de errores (ErrorApi) + headers + environment - 6h
