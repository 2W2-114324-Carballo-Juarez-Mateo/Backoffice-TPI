...
El Backoffice depende de **contratos de lectura** con los temas que le proveen datos (02 Cursos/Matrícula (incl. encuestas CSAT), 03 Desafíos (`challenge.events`), 05 Prácticos, 07 Evaluación LLM, 08 Banco, 10 Roadmap). Sin esos contratos acordados en el sprint 1, el Backoffice no tiene nada demostrable (es consumidor puro).
