...
1. **Qué es el Backoffice**: un **"consumidor puro"** (no fabrica datos, administra configuración y muestra/lee lo que producen otros temas) con **2 microservicios propietarios**: Administration & Configuration (parámetros PAR-01..23 (PAR-24 asignado al Tema 01) + gestión del proveedor LLM exclusiva de ADMIN) y Reporting & Analytics (reportes docentes, panel del profesor, métricas CSAT 5★, exportación, alertas).
